...
{  
    IRdbSource source;  
    source.driverName = "QMYSQL";  // Note: MariaDb often uses the same driver as MySQL in Qt
    source.databaseName = "TestDb";  
    source.host = "127.0.0.1";  
    source.user = "root";  
    source.password = "xxxx";  
...
Users should inherit `IRdbDialectInterface` to create a custom dialect. Override necessary functions, ensuring consistency in naming (e.g., `IRdbXx xxDialect`).
